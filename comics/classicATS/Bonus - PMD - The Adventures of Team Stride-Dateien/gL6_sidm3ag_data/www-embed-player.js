...
rf("//web.archive.org/web/20190130224116/https://static.doubleclick.net/instream/ad_status.js",a);Df.push(zf(function(){Ef||"google_ad_status"in window||(xf("//web.archive.org/web/20190130224116/https://static.doubleclick.net/instream/ad_status.js",a),Ef=!0,P("DCLKSTAT",3))},5E3))}}
...
b=Ke("//web.archive.org/web/20190130224116/https://googleads.g.doubleclick.net/pagead/id",a)}),function(a){a instanceof Gd&&b.abort();
return Cd(a)})}
...
;function Di(a){if("1"!==bb(le(),"args","privembed")){a&&me();try{Ci().then(function(a){a=pe(a);a.bsq=Ei++;Qe("//web.archive.org/web/20190130224116/https://www.youtube.com/ad_data_204",{va:!1,B:a,withCredentials:!0})},function(){}),T(Di,18E5)}catch(b){R(b)}}}
...
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Jf.dispose();a=0;for(var b=Df.length;a<b;a++)Cf(Df[a]);Df.length=0;wf("//web.archive.org/web/20190130224116/https://static.doubleclick.net/instream/ad_status.js");Ef=!1;P("DCLKSTAT",0);ed(Li,Ki);if(a=Ji)a.removeEventListener("onScreenChanged",Oi),a.removeEventListener("onLogClientVeCreated",Ni),a.removeEventListener("onLogServerVeCreated",Pi),a.removeEventListener("onLogVeClicked",Qi),a.removeEventListener("onLogVesShown",Ri),a.removeEventListener("onReady",Si),a.destroy();Mi=
{}});
...
/*
     FILE ARCHIVED ON 22:41:16 Jan 30, 2019 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 15:36:31 Nov 19, 2020.
...
/*
playback timings (ms):
  LoadShardBlock: 313.394 (3)
  esindex: 0.042
  PetaboxLoader3.resolve: 424.225 (2)
  RedisCDXSource: 63.105
  exclusion.robots: 0.205
  PetaboxLoader3.datanode: 978.746 (5)
  CDXLines.iter: 27.663 (3)
  exclusion.robots.policy: 0.19
  captures_list: 556.553
  load_resource: 1231.445 (2)
*/