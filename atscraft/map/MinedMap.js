...
window.createMap = function () {
	...
	xhr.onload = function () {
		...
		L.marker([-1200,600], { title: "Survival Spawn" }).addTo(map);
		L.marker([-1611,817], { title: "Melon Land" }).addTo(map);
		L.marker([-1652,525], { title: "Pigio" }).addTo(map);
		L.marker([-1269,100], { title: "Chunk Error Village" }).addTo(map);
		L.marker([-1126,688], { title: "Pixel's Home" }, { icon: "pixelIcon" }).addTo(map);
        ...
        [-1294, 11],
        [-1281, 7]];
		var poly = L.polygon(cev).addTo(map);
        ...
        [-1671, 857],
        [-1660, 705]];
		var poly = L.polygon(melonLand).addTo(map);
